import time
####################THIS IS ORIGINAL BIT SUBSTITUTION
...
#Maybe have it so user chooses letter and then AI compares images and tells user which is best, for a fixed
#image, and with also an image the user can choose themselves.