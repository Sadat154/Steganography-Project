...
class TestMessageToBin(unittest.TestCase):
    ...
    def test_empty_string(self):
        self.assertEqual(
            self.message_to_bin(""), "", "Empty string should return an empty string"
        )

    def test_single_character(self):
        self.assertEqual(
            self.message_to_bin("a"),
            "01100001",
            'Character "a" should return "01100001"',
        )

    def test_multiple_characters(self):
        self.assertEqual(
            self.message_to_bin("abc"),
            "011000010110001001100011",
            'String "abc" should return "011000010110001001100011"',
        )
...
class TestOpenImage(unittest.TestCase):
    ...
    def test_valid_image_path(self):
        ...
        self.assertIsInstance(
            opened_img, Image.Image, "Should return an instance of PIL.Image.Image"
        )
        opened_img.close()
...
class TestDecimalToBinary(unittest.TestCase):
    ...
    def test_zero(self):
        self.assertEqual(
            self.decimal_to_binary(0), "00000000", 'Decimal 0 should return "00000000"'
        )

    def test_positive_integer(self):
        self.assertEqual(
            self.decimal_to_binary(10),
            "00001010",
            'Decimal 10 should return "00001010"',
        )

    def test_large_positive_integer(self):
        self.assertEqual(
            self.decimal_to_binary(255),
            "11111111",
            'Decimal 255 should return "11111111"',
        )
...
class TestBinaryToDecimal(unittest.TestCase):
    ...
    def test_zero(self):
        self.assertEqual(
            self.binary_to_decimal("00000000"), 0, 'Binary "00000000" should return 0'
        )

    def test_positive_integer(self):
        self.assertEqual(
            self.binary_to_decimal("00001010"), 10, 'Binary "00001010" should return 10'
        )

    def test_large_positive_integer(self):
        self.assertEqual(
            self.binary_to_decimal("11111111"),
            255,
            'Binary "11111111" should return 255',
        )
...
class TestResizeImage(unittest.TestCase):
    ...
    def test_resize_image(self):
        ...
        self.assertEqual(
            ...
            (16, 16),
            "Image of size 10x10 should be resized to 16x16",
        )
    ...
    def test_image_already_multiple_of_eight(self):
        ...
        resized_img, new_height, new_width = self.resize_image(img)
        self.assertEqual(
            (new_width, new_height), (16, 16), "Image of size 16x16 should remain 16x16"
        )
...
class TestAdjustBitmask(unittest.TestCase):
    ...
    def test_zero(self):
        self.assertEqual(
            self.adjust_bitmask(0), 128, "Bit position 0 should return 128"
        )

    def test_positive_integer(self):
        self.assertEqual(
            self.adjust_bitmask(3), 240, "Bit position 3 should return 240"
        )

    def test_large_positive_integer(self):
        self.assertEqual(
            self.adjust_bitmask(7), 255, "Bit position 7 should return 255"
        )
