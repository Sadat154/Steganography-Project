...
bit_position = 4 # The bit position chosen does not matter for the purpose of tests 1.1-1.4
...
image_object = BitSubEncoderDecoder(testing_image_path, output_image_path, secret_message,bit_position)
try:
...
try:
    for i in range(0,8): #Bit
        ...
        image_object = BitSubEncoderDecoder(testing_image_path, output_image_path, secret_message, i)
        image_object.encode_image()
    print("1.5 Completed")
...
bit_position = 4 # The bit position chosen does not matter for the purpose of tests 2.1-2.4
channel_choice = 'r' # The channel chosen does not matter for the purpose of tests 2.1-2.4
