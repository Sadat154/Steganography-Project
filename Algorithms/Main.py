    ...
    with open("Index.html", "w") as f:
        ...
        for i in range(rows_bitsub):
            ...
            for j in range(1, images_per_row + 1):
                ...
                """.format(
                        (i * images_per_row) + j, (i * images_per_row) + j
                    )
                )
...
if __name__ == "__main__":
    ...
    3. Both
    **NOTE** Please ensure you have placed the image files you would like to test in the 'OriginalImages' folder **NOTE** """
    )

    if get_user_choice == "1":
        # Then we generate for BitSub
        pass
    elif get_user_choice == "2":
        # then we genererate for DCT
        pass
    else:  # Regardless of if they input 3 or an invalid input, we will do both
        pass
