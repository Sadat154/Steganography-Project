...
class BitEncoderDecoder:
    ...
    def encode_lsb(self, secret_message):
    ...
    def decode_lsb(self):
        encoded_image = Image.open(self.original_image_path)
...
bit_encoder_decoder = BitEncoderDecoder(original_image_path, output_image_path, delim) #Object
bit_encoder_decoder.encode_lsb(secret_message) #Object has been encoded
decoded_message = bit_encoder_decoder.decode_lsb() #Decode the object
